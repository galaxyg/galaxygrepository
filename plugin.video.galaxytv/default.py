...
addon = xbmcaddon.Addon('plugin.video.Yulfiostv')
...
SOURCES = [{"url": "http://serveriptvpy.com/menu.xml", "fanart": "http://images.forwallpaper.com/files/images/3/3800/3800a2af/94026/gorgeous-galaxy.jpg", "genre": "Tv Live", "date": "08.01.2015", "credits": "GALAXYtv", "thumbnail": "https://scontent-gru1-1.xx.fbcdn.net/hphotos-xfa1/v/t34.0-0/p206x206/12179448_1699356173630505_1763898245_n.jpg?oh=e71cca85bcdff66ef83a5d6adb9cd4f7&oe=56343213"}]

# http://images.forwallpaper.com/files/images/3/3800/3800a2af/94026/gorgeous-galaxy.jpg
# https://scontent-gru1-1.xx.fbcdn.net/hphotos-xfa1/v/t34.0-0/p206x206/12179448_1699356173630505_1763898245_n.jpg?oh=e71cca85bcdff66ef83a5d6adb9cd4f7&oe=56343213
...
def addon_log(string):
    if debug == 'true':
        xbmc.log("[addon.galaxytv-%s]: %s" %(addon_version, string))
...
def makeRequest(url, headers=None):
        try:
            ...
            if hasattr(e, 'code'):
                ...
                xbmc.executebuiltin("XBMC.Notification(yulfiostv,We failed with error code - "+str(e.code)+",10000,"+icon+")")
            elif hasattr(e, 'reason'):
                addon_log('We failed to reach a server.')
                addon_log('Reason: %s' %e.reason)
                xbmc.executebuiltin("XBMC.Notification(yulfiostv,We failed to reach a server. - "+str(e.reason)+",10000,"+icon+")")
...
def addSource(url=None):
        ...
        xbmc.executebuiltin("XBMC.Notification(yulfiostv,New source added.,5000,"+icon+")")
        if not url is None:
